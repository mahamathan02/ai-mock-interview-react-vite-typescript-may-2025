  ...
  return (
    <div className="flex-col w-full pb-24">
      <ContainerPage className="">
        <div className=" my-8">
          <h2 className="text-3xl text-center md:text-left md:text-6xl">
            ...
            <br />
            improve your interview chnaces and skills
          </h2>

          <p className="mt-4 text-muted-foreground text-sm">
            Boast your interview skills and increase your succes rate with AI-driven insights . Discover a smarter way to prepare , practice , and stand out
          </p>
        </div>
      ...
      <div className="w-full my-12">
        <Marquee className="w-full my-12">
      ...
      <ContainerPage className="py-8 space-y-8">
